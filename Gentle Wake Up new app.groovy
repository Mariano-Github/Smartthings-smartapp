 ...
 *
 *  January 2021, Mariano Colmenarejo: To install in the new app, you must also create and publish for you the DTH "Gentle wake Up Controller", so the virtual switch that starts and stops the light regulation will be created. 
 *  When turning OFF the virtual switch always stops the regulation in the point that is. Virtual switch can be controlled from an automation or smartlighting app.
 */
definition(
	name: "Gentle Wake Up",
